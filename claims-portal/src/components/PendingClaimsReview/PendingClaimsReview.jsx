                ...
                <DxcFlex direction="column" gap="var(--spacing-gap-s)">
                  <DxcFlex justifyContent="space-between" alignItems="center">
                    <DxcFlex gap="var(--spacing-gap-m)" alignItems="center">
                      <DxcTypography fontWeight="font-weight-semibold" #000000" fontSize="font-scale-04">
                        {claim.claimNumber}
                      </DxcTypography>
            ...
            <div style={{
              ...
              <DxcFlex direction="column" gap="var(--spacing-gap-s)">
                <DxcFlex justifyContent="space-between" alignItems="center">
                  ...
                  <DxcTypography fontWeight="font-weight-semibold" fontSize="32px" #000000">
                    ...
                    <DxcFlex direction="column" gap="var(--spacing-gap-m)">
                      ...
                      <DxcFlex justifyContent="space-between" alignItems="center">
                        <DxcFlex gap="var(--spacing-gap-s)" alignItems="center">
                          <DxcTypography fontWeight="font-weight-semibold" #000000">
                            {policy.policyNumber}
                          </DxcTypography>
                      ...
                      <div key={idx} style={{
                        ...
                        <DxcFlex direction="column" gap="var(--spacing-gap-s)">
                          <DxcFlex justifyContent="space-between" alignItems="center">
                            ...
                            <DxcTypography fontWeight="font-weight-semibold" fontSize="font-scale-04" #000000">
